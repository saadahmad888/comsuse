...
export default class AboutFourLeft extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
        ...
        return (
            <>
                ...
                <div className="row padding-top-90px align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="service-item pl-4 mb-0">
                            <h3 className="widget-title padding-bottom-15px line-height-33">How to project yourself when travelling during the coronavirus(COVID-19) outbreak</h3>
